...
git clone https://github.com/MITRECND/abcd &&
git clone https://github.com/CroweCybersecurity/ad-ldap-enum &&
git clone https://github.com/sahakkhotsanyan/adfind &&
git clone https://github.com/sshock/AFFLIBv3 &&
git clone https://github.com/CoreSecurity/Agafi &&
git clone https://github.com/tintinweb/aggroArgs &&
git clone https://github.com/v1s1t0r1sh3r3/airgeddon &&
git clone https://github.com/doyensec/ajpfuzzer &&
git clone https://github.com/lanjelot/albatar &&
...
git clone https://github.com/Flo354/Androick &&
git clone https://github.com/bbqlinux/android-udev-rules &&
...
git clone https://github.com/salls/angrop &&
git clone https://github.com/lewangbtcc/anti-XSS &&
git clone https://github.com/Acey9/apacket &&
...
git clone https://github.com/alexpark07/ARMSCGen &&
git clone https://github.com/he2ss/arpstraw &&
git clone https://github.com/ntrippar/ARPwner &&
git clone https://github.com/mthbernardes/ARTLAS &&
git clone https://github.com/quarkslab/arybo &&
git clone https://github.com/NORMA-Inc/AtEar &&
git clone https://github.com/AlisamTechnology/ATSCAN-V3.1 &&
git clone https://github.com/skahwah/automato &&
git clone https://github.com/redteamsecurity/AutoNessus &&
git clone https://github.com/nccgroup/autopwn &&
git clone https://github.com/bharshbarger/AutOSINT &&
...
git clone https://github.com/mrjopino/backcookie &&
git clone https://github.com/secretsquirrel/the-backdoor-factory &&
git clone https://github.com/Kkevsterrr/backdoorme &&

git clone https://github.com/localh0t/backfuzz &&
git clone https://github.com/l0gan/backHack &&
git clone https://github.com/bwall/BAMF &&
git clone https://github.com/yvesalexandre/bandicoot &&
...
git clone https://github.com/aancw/Belati &&
...
git clone https://github.com/Vector35/binaryninja-python &&
git clone https://github.com/elfmaster/binflow &&
git clone https://github.com/Hood3dRob1n/BinGoo &&
git clone https://github.com/google/binnavi &&
...
git clone https://github.com/RandomStorm/Bluto && 
...
git clone https://github.com/CapacitorSet/box-js && 
git clone https://github.com/gabemarshall/Brosec && 
...
git clone https://github.com/Danladi/HttpPwnly && 
...
blackarch-cracker |git clone https://github.com/BL4CKvGHOST/Ob3vil1on && 
...
git clone https://github.com/houssniyh/pwnloris && 
